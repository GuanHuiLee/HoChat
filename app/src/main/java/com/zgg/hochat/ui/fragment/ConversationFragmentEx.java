...
import com.zgg.hochat.bean.CSEvaluateInfo;
...
public class ConversationFragmentEx extends ConversationFragment {
    public static final String TAG = ConversationFragmentEx.class.getName();
    private List<CSEvaluateItem> mEvaluateList;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        RongIMClient.getInstance().setCustomServiceHumanEvaluateListener(new CustomServiceManager.OnHumanEvaluateListener() {
            ...
            public void onHumanEvaluate(JSONObject evaluateObject) {
                ...
                CSEvaluateInfo sealCSEvaluateInfo = new CSEvaluateInfo(jsonObject);
